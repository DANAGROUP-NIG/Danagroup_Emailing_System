...
function buildCSPHeader(nonce: string, isDev: boolean): string {
  ...
  const directives = [
    ...
    "img-src 'self' data: blob: http://minio:9000 http://localhost:9000 http://localhost:3000 https://dims.danagroup.internal https://danagroup.net https://www.danagroup.net",
    `connect-src 'self' ws://dims.danagroup.internal wss://dims.danagroup.internal wss://danagroup.net wss://www.danagroup.net http://localhost:8000 ws://localhost:8000${wsConnectExtra}${devConnectExtra}`,
