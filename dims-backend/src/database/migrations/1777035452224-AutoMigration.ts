...
export class AutoMigration1777035452224 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "user_thread_state" ("id" SERIAL NOT NULL, "user_id" uuid NOT NULL, "thread_id" uuid NOT NULL, "unread_count" integer NOT NULL DEFAULT '0', "is_starred" boolean NOT NULL DEFAULT false, "is_read" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_26ac1226166cf144f95f885b699" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_88500ce10bcadc40f9264cc90f" ON "user_thread_state" ("user_id", "thread_id") `,
    );
    await queryRunner.query(
      `CREATE TABLE "threads" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "subject" character varying(500) NOT NULL, "snippet" text, "last_activity_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "last_message_at" TIMESTAMP, CONSTRAINT "PK_d8a74804c34fc3900502cd27275" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_e19b8c94e6afc03c66622dc7dc" ON "threads" ("last_activity_at") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_0973d3108a6a262459cdd7f305" ON "threads" ("last_message_at") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_55e5b3d0811df1361924239537" ON "messages" ("thread_id", "sent_at") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "user_thread_state" ADD CONSTRAINT "FK_32260684eea0336fa62896068e7" FOREIGN KEY ("thread_id") REFERENCES "threads"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "user_thread_state" DROP CONSTRAINT "FK_32260684eea0336fa62896068e7"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_55e5b3d0811df1361924239537"`,
    );
    await queryRunner.query(`DROP TABLE "messages"`);
    await queryRunner.query(`DROP TABLE "attachments"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_0973d3108a6a262459cdd7f305"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_88500ce10bcadc40f9264cc90f"`,
    );
